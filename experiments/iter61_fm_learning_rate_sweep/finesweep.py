"""iter61 (part 2): fine-grained FM learning_rate sweep around 0.0005."""
import os, sys
import numpy as np
...
if __name__ == '__main__':
    ...
    LR_GRID = [0.0003, 0.0004, 0.0005, 0.0006, 0.0007, 0.0008]
    results = []
    for lr in LR_GRID:
    ...
    print(f"iter38 baseline (lr=0.001): valid=0.63894 test=0.63989")

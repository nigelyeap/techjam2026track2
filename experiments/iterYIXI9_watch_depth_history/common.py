"""Fixed post-6h references and fitting helpers for YIXI Section 6i."""
...
ENSEMBLE_REFERENCE_VALID = 0.6841553449630737
ENSEMBLE_REFERENCE_TEST = 0.6743725538253784
FM_REFERENCE_VALID = 0.6398779153823853
CURRENT_XGB_VALID = 0.6675541996955872
CURRENT_WEIGHTS = {"fm": 0.24, "lgb": 0.42, "xgb": 0.34}
...
def record(name, feature, columns, model, metrics, fractions, family):
    best_iteration = (

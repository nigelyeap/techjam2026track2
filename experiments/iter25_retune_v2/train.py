...
def run_bpr_ext(data_dir, feature_set=('decay_rate_3', 'decay_act_3', 'tab'), halflives=HALFLIVES,
                 ...
                 steps_mult=1, K=5, splits_cache=None, alpha=ALPHA, n_buckets=10):
    ...
    alpha: Laplace-smoothing constant for rate/decay_rate/lastk_rate features
    (iter25: sweepable, mirrors iter21's change). n_buckets: quantile bucket
    count for all bucketed continuous features (iter25: sweepable)."""
...
if __name__ == '__main__':
    ...
    res = run_bpr_ext(a.data_dir, feature_set=feature_set, k=a.k, lr=a.lr, epochs=a.epochs,
                       ...
                       steps_mult=a.steps_mult, K=a.K, alpha=a.alpha, n_buckets=a.n_buckets)
    print(f"\n=== iter25 fm+bpr_weighted+{'+'.join(feature_set)} (seed={a.seed}) ===")

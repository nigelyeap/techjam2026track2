"""iter24: FM + activity-weighted BPR pairwise loss (identical loss/sampling
mechanism to iter3/iter9/iter16/iter18/iter19/iter20), fed the extended
feature encoding from this dir's data_ext.py, which fuses iter20's fine-grid
decay_rate/decay_act + decayed decay_tab with iter18/iter19's momentum
features (last1/lastk_rate/gap).

Loss, optimizer, sampling, hyperparams are all a line-for-line copy of
iter19/iter20's train.py (themselves copied from iter3/iter9). Reuses
...
if __name__ == '__main__':
    ...
    print(f"\n=== iter24 fm+bpr_weighted+{'+'.join(feature_set)} (seed={a.seed}) ===")
